...
| --- | --- | --- |
| Living baseline | Repeated failures produced new operating rules instead of tribal memory. | [`ADEV.md` operational lessons](https://github.com/scanalesespinoza/adev/blob/main/ADEV.md#operational-lessons-consolidated-from-homedir) |
...
For the practice architecture and the evidence shelf, see [`framework/evidence/README.md`](https://github.com/scanalesespinoza/adev/blob/main/framework/evidence/README.md). For the emerging agent-governance evidence chain, see [`framework/hardness/README.md`](https://github.com/scanalesespinoza/adev/blob/main/framework/hardness/README.md).
