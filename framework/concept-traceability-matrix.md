...
| Autonomous Review & Merge Gates | [`Hardness review policy & merge gate`](hardness/08-autonomous-review-and-merge-gate-policy.md) | [`Action risk model`](hardness/04-action-risk-authority-model.md) | Standard `pr:risk-*` label taxonomy and decision algorithm | Operational proof in pipeline automation | [Chapter 08](../adevelopment-book/book-en/08-autonomy-security-and-responsibility.md) | established for doctrine and pipeline spec |
