...
| Issue Definition-of-Ready | [`Hardness Issue DoR and Atomicity`](hardness/08-issue-definition-of-ready.md) | [`Hardness agent consumption`](hardness/06-agent-consumption-guide.md) | [`AGENT_ISSUE_template.md`](../starter-kit/AGENT_ISSUE_template.md), [`.github/ISSUE_TEMPLATE/agent-task.yml`](../.github/ISSUE_TEMPLATE/agent-task.yml) | No automated intake bot evaluation or direct Homedir artifact recorded yet. | [Chapter 03](../adevelopment-book/book/03-atomic-iterations.md) and [Appendix A](../adevelopment-book/book/appendices/A-templates.md) | foundation — normative spec, schema, and templates established |
