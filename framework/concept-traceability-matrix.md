...
| Evidence | [`ADEV.md` evidence rules](../ADEV.md#evidence-rules) | [`docs/case-studies/`](../docs/case-studies/) | [`FIRST_RELEASE.md`](../starter-kit/FIRST_RELEASE.md), [`DECISION_LOG.md`](../starter-kit/DECISION_LOG.md) | [`docs/evidence-index.md`](../docs/evidence-index.md) is an index, not a direct source; artifact-level Homedir links are a stated gap: [Homedir](https://github.com/scanalesespinoza/homedir) | [Chapter 05](../adevelopment-book/book/05-traceability-digital-thread.md) | partial — attribution migration pending |
