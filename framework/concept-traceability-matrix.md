...
| AI-SDLC Contract | [`AI-SDLC Schema & Spec`](ai-sdlc/01-specification.md) | [`framework/ai-sdlc`](ai-sdlc/README.md) | [`ai-sdlc_template.yaml`](../starter-kit/ai-sdlc_template.yaml) | Production-grade archetypes in [`framework/ai-sdlc/examples`](ai-sdlc/examples/) | [Chapter 08](../adevelopment-book/book-en/08-autonomy-security-and-responsibility.md) | established for schema, kit, and examples |
| Progressive Autonomy | [`Progressive Autonomy Ladder`](ai-sdlc/01-specification.md#3-the-progressive-autonomy-ladder--risk-matrix) | [`Hardness action risk model`](hardness/04-action-risk-authority-model.md) | [`ai-sdlc_template.yaml`](../starter-kit/ai-sdlc_template.yaml) | Multi-tier test fixtures in [`framework/ai-sdlc/fixtures`](ai-sdlc/fixtures/) | [Chapter 08](../adevelopment-book/book-en/08-autonomy-security-and-responsibility.md) | established |
