...
| Prompt-injection defense | [`Prompt-injection defense specification`](hardness/08-prompt-injection-defense.md) | [`Hardness agent consumption guide`](hardness/06-agent-consumption-guide.md) | [`Untrusted envelope example`](hardness/fixtures/untrusted-content-envelope-example.json), [`Injection defense policy fixture`](hardness/fixtures/valid-prompt-injection-policy.json) | Reference prior art in hermes #19; full cross-vector evaluation suite pending. | [Chapter 08 (Security)](../adevelopment-book/book-en/08-autonomy-security-and-responsibility.md) | foundation — normative spec and fixtures established; cross-runtime integration ongoing |
